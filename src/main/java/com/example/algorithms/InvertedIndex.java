...
//        System.out.println("finish");
    ...
    public List<String> andSearch(String textToSearch) {
        ...
        List<String> firstWordDocs = indexMap.get(splitText[0]);
        List<String> secondWordDocs = indexMap.get(splitText[2]);
        try {
    ...
    public List<String> notSearch(String textToSearch) {
        ...
        if (splitText.length == 2 && splitText[0].equals("not")) {
            List<String> wordFoundDocs = indexMap.get(splitText[1]);
